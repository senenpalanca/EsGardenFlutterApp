        ...
        child: new Card(
          ...
          child: GestureDetector(
            onTap: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => PlotsOfGarden(OrchardKey:OrchardKey)),
            ...
            child: Container(
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(child: Text("(0) \u00B7 "+plots.length.toString()+" Plot(s)",
                      style: TextStyle(color: Colors.black54, fontSize: 18.0,),)),
                  ],)),
          ),
          Container(child: Text("Sunny" + " \u00B7 "+ Location,
