...
class SimpleLineChart extends StatelessWidget {
  ...
  factory SimpleLineChart.createDataHumidity(List data1, List data2,int maxValue) {
    return new SimpleLineChart(
  ...
  Widget build(BuildContext context) {
    ...
    return new charts.TimeSeriesChart(
      seriesList,
      defaultRenderer: new charts.LineRendererConfig(includeArea: true, stacked: true,includePoints: true,includeLine: true),
      animate: false,
      behaviors: [ new charts.PanAndZoomBehavior(), new charts.SlidingViewport(),],
  ...
  static List<charts.Series<TimeSeriesValue, DateTime>> _createDataTemperature(List<DataElement> data) {
// final data = [
//   new DataItem(0, 5),
//   new DataItem(1, 25),
//   new DataItem(2, 100),
...
// ];
    ...
    for (var i = 0; i < DataElements.length; i++) {
      ...
      dataList.add(new TimeSeriesValue(DataElements[i].timestamp, DataElements[i].Fields[j]));
      }
...
// ];
  ...
  static List<charts.Series<TimeSeriesValue, DateTime>> _createDataCO2(List<DataElement> data) {
// final data = [
//   new DataItem(0, 5),
//   new DataItem(1, 25),
//   new DataItem(2, 100),
...
// ];
  ...
  static List<charts.Series<DataItem, int>> _createDataHumidity(List data1, List data2) {
// final data = [
//   new DataItem(0, 5),
//   new DataItem(1, 25),
//   new DataItem(2, 100),
