...
class FormPlot extends StatefulWidget {
  ...
  FormPlotState createState (){
   ...
   // if(!vegetables.isEmpty){vegetables.clear();}
    ...
    final databaseReferenceVegetable = _database
        .child("Vegetable")
        .onChildAdded
...
class FormPlotState extends State<FormPlot> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    PersonalizedField2(nameContoller,"Name of the Plot", false,Icon(Icons.note_add, color: Colors.white)),
  ...
  Widget _createDropDownItem(String value){
    switch(value){
      case '0':
        return new Text(_getTextVegetable(value)
 ...
 String _getTextVegetable(String num){
        ...
        if(!_ValidateFields()){
          showDialog(context: context,builder:(context){
            return AlertDialog(
              ...
              content: Text("Check your fields, maybe your name it's used yet."),
            );
          });
        }else{
          showDialog(context: context,builder:(context){
            return AlertDialog(
              ...
              content: Text("The plot "+nameContoller.text+" has been created!"),
            );
          });
        }
      },
      label: Text('Create Plot',style: TextStyle(fontSize: 20.0),),
  ...
  void createRecord(){
    ...
    var set = databasePlot.child("plot "+(widget.plots.length-2).toString()).set({
      ...
      "Img"             : widget.vegetables[int.parse(vegetableValue)-1].Img, //La llave del misterio
      "Items"           : ["Vegetable"],
