              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    PersonalizedField2(nameContoller, "Name of the Garden",
                        false, Icon(Icons.note_add, color: Colors.white)),
                    PersonalizedField2(cityContoller, "City of the Garden",
                    ...
                    PersonalizedField2(imgContoller, "Image URL Logo", false,
    ...
    databaseReference.child(nameContoller.text).set({
      ...
      "sensorData": {
        ...
        "Nursery": {
          ...
          "Img":
              "https://i.ibb.co/ZYFqJyM/PLANTA-web.jpg",
          "Parent": nameContoller.text,
          "Vegetable": "General"
        },
        "SoilCompost": {
